    ...
    const settingsSchema = new mongoose.Schema(
      {
        ...
        strategyProfile: { type: String, enum: ['swing', 'active'], default: 'swing' },
        activeWatchlist: { type: [String], default: ['SPY', 'QQQ'] },
        activeChartInterval: { type: String, default: '15m' },
        activeChartRange: { type: String, default: '5d' },
        activeMinScore: { type: Number, default: 68 },
        activeMinExternal: { type: Number, default: 40 },
        targetProfitPerTradeUsd: { type: Number, default: 6 },
        targetRiskPerTradeUsd: { type: Number, default: 4 },
        dailyProfitTargetUsd: { type: Number, default: 15 },
        dailyLossLimitUsd: { type: Number, default: null },
        maxTradesPerDay: { type: Number, default: 5 },
        eodFlattenEnabled: { type: Boolean, default: true },
    ...
    const tradeSchema = new mongoose.Schema(
      {
        ...
        exitReason: {
          type: String,
          enum: ['stop', 'take_profit', 'manual', 'eod', 'unknown', ''],
          default: '',
        },
        openedAt: Date,
        closedAt: Date,
        ...
        lastMarkPriceAt: Date,
        lastMarkScanId: String,
    ...
    const riskSchema = new mongoose.Schema(
      {
        ...
        dailyPnlDayKey: String,
        tradesTodayCount: { type: Number, default: 0 },
        vix: Number,
