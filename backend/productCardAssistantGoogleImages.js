 ...
 * Асистент картки товару більше не викликає CSE (див. productCardAssistant.js — лише SerpApi / Commons).
 * Модуль лишено для сортування за .ua та за потреби ручного/тестового виклику googleCustomSearchImages.
 */
