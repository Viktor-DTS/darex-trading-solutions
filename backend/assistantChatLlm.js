...
Якщо в повідомленні користувача до моделі є блок «[DTS-assistant-scope]», користувач просить щось поза текстовими можливостями (зокрема файл звіту, експорт Excel/PDF тощо). Дотримуйся інструкцій у цьому блоці: поясни обмеження чату, короткий нумерований перелік того, що **можна зробити** з наявним контекстом [DTS] (підсумок, доступ, кнопки картки, експорт через саму DTS UI, навігація), заверши формулюванням «оберіть, що потрібно». Не дублюй довгі переліки тих самих заявок лише через те, що нова репліка була про «звіт» — нагади стисло або переадресуй на експорт у таблиці.
