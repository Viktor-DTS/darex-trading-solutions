...
Блок [DTS-discovery] із кількох заявок — це лише записи, видимі цьому користувачу за правилами доступу DTS (див. [DTS-discovery-access] у тому ж повідомленні): не кажи, що це «усі» збіги в системі. Перелічи номери заявок, коротко вкажи в яких полях видно шукані дані, і спитай один конкретний номер KV/DP, який цікавить; без явного вибору не розписуй повні картки кожної заявки.
