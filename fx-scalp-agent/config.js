...
module.exports = {
  ...
  posTimeScratchMs: num('FX_POS_TIME_SCRATCH_MS', charlieMode ? 420000 : 300000),
  posTimeScratchLossMs: num('FX_POS_TIME_SCRATCH_LOSS_MS', charlieMode ? 240000 : 180000),
  posScratchMaxLossPips: num('FX_POS_SCRATCH_MAX_LOSS_PIPS', -0.5),
  posTimeMaxMs: num('FX_POS_TIME_MAX_MS', charlieMode ? 900000 : 600000),
  posProgressPips: num('FX_POS_PROGRESS_PIPS', 0.5),
  ...
  mathMicroMinM1: num('FX_MATH_MICRO_M1', 3),
