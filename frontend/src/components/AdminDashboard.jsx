        ...
        <>
          <div className="notifications-info">
            ...
            <p className="notifications-info-hint">
              ...
              Інші колонки VZ: після чекбокса є фільтр по заявці — отримує той, хто її подав, плюс адміністратор (з чекбоксом) і канал TELEGRAM_ADMIN_CHAT_ID. Чужі заявки менеджерам не розсилаються.
              ...
              «VZ: відхилено» — заявник + адміністратори завжди.
            </p>
          </div>
