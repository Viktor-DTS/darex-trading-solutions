...
const KIND_LABELS = {
  ...
  task_cashless_no_invoice_pending: 'Безготівка без рахунку',
  assistant_accountant_relay: 'Пояснення для бухгалтерії',
  assistant_accountant_relay_reply: 'Відповідь бухгалтерії',
