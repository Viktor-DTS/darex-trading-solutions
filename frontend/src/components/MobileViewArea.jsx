...
export default function MobileViewArea({ user }) {
  ...
  const handleFileUpload = async (files, taskId, description = '') => {
    ...
    // Додаємо файли (PDF конвертація тепер на сервері)
  ...
  return (
    <div style={{ padding: '16px', maxWidth: '100%', background: 'transparent', minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      <h2 style={{ 
        marginBottom: '20px', 
        color: '#22334a',
        fontSize: '24px',
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 8px',
              border: 'none',
              background: activeTab === 'confirmed' ? '#ffc107' : 'transparent',
