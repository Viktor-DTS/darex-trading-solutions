    ...
    <div className="category-management">
      <div className="category-management-header">
        ...
        <p className="category-management-desc">
          ...
          Прапорець <strong>«менеджерам»</strong> біля рядка або в формі: якщо увімкнено, група та всі підгрупи показуються у панелі <strong>«Менеджери» → Залишки на складах</strong> (у т.ч. якщо зайшли під адміністратором). Якщо жодна група не позначена — там показуються всі залишки (як раніше).
        </p>
